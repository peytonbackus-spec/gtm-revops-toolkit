...
- **Lead-to-Account Matcher:** [l2a_matching_engine](../../core/engine/l2a_matcher.py) -- `core/engine/l2a_matcher.py`
...
**Not yet built:** an attribution SQL engine (`w_shaped_attribution.sql`) was referenced in the pre-consolidation manifest but was never actually written -- flagging here rather than re-promising it silently. No tracked project covers this work yet; [attribution-model](../agents/attribution-model.md) is the closest existing spec.
...
## See Also
[README](../../README.md) . [gtm-stack-integration-architecture](../../wiki/concepts/gtm-stack-integration-architecture.md) . [full-org-agent-taxonomy](../../wiki/concepts/full-org-agent-taxonomy.md)
