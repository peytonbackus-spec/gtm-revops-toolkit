...
## Built
- [Speed-to-Lead SLA Server](speed-to-lead/README.md) (proof of concept) -- implements [speed-to-lead-sla-contract](../contracts/speed-to-lead-sla-contract.md). 1 of 5 tools is real logic; 4 are mocked pending real CRM/calendar/Slack/sequencer credentials. Schema: [I/O Schema](../schemas/speed-to-lead-sla.schema.md).
...
## See Also
[README](../../README.md) . [Workflow Contracts](../contracts/pipeline-risk-contract.md) . [00-Code-Index](../code/00-Code-Index.md)
